...
def test_test_command_list_plugins() -> None:
    ...
    with patch("lintro.cli_utils.commands.test.run_lint_tools_simple") as mock_run:
        ...
        call_args = mock_run.call_args
        assert_that(call_args.kwargs["tool_options"]).contains("pt:list_plugins=True")
...
def test_test_command_check_plugins() -> None:
    ...
    with patch("lintro.cli_utils.commands.test.run_lint_tools_simple") as mock_run:
        ...
        call_args = mock_run.call_args
        assert_that(call_args.kwargs["tool_options"]).contains("pt:check_plugins=True")
...
def test_test_command_collect_only() -> None:
    ...
    with patch("lintro.cli_utils.commands.test.run_lint_tools_simple") as mock_run:
        ...
        call_args = mock_run.call_args
        assert_that(call_args.kwargs["tool_options"]).contains("pt:collect_only=True")
...
def test_test_command_fixtures() -> None:
    ...
    with patch("lintro.cli_utils.commands.test.run_lint_tools_simple") as mock_run:
        ...
        call_args = mock_run.call_args
        assert_that(call_args.kwargs["tool_options"]).contains("pt:list_fixtures=True")
...
def test_test_command_markers() -> None:
    ...
    with patch("lintro.cli_utils.commands.test.run_lint_tools_simple") as mock_run:
        ...
        call_args = mock_run.call_args
        assert_that(call_args.kwargs["tool_options"]).contains("pt:list_markers=True")
...
def test_test_command_coverage_options() -> None:
    ...
    with patch("lintro.cli_utils.commands.test.run_lint_tools_simple") as mock_run:
        ...
        call_args = mock_run.call_args
        assert_that(call_args.kwargs["tool_options"]).contains(
            "pt:coverage_html=htmlcov",
        )
        assert_that(call_args.kwargs["tool_options"]).contains(
            "pt:coverage_xml=coverage.xml",
        )
...
def test_test_command_multiple_new_flags() -> None:
    ...
    with patch("lintro.cli_utils.commands.test.run_lint_tools_simple") as mock_run:
        ...
        assert_that(tool_options).contains("pt:list_plugins=True")
        assert_that(tool_options).contains("pt:list_markers=True")
        assert_that(tool_options).contains("pt:collect_only=True")
...
def test_test_command_combined_options() -> None:
    ...
    with patch("lintro.cli_utils.commands.test.run_lint_tools_simple") as mock_run:
        ...
        assert_that(call_args.kwargs["verbose"]).is_true()
        assert_that(call_args.kwargs["raw_output"]).is_true()
        assert_that(call_args.kwargs["tool_options"]).contains("pt:maxfail=5")
