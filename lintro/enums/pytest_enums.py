...
class TestStatus(StrEnum):
    ...
    Values are upper-case string identifiers to align with pytest output.
    """
...
def normalize_pytest_special_mode(value: str | PytestSpecialMode) -> PytestSpecialMode:
    ...
    Raises:
        ValueError: If the value is not a valid special mode.
    """
...
def normalize_pytest_output_format(
    ...
    Raises:
        ValueError: If the value is not a valid output format.
    """
...
def normalize_test_status(value: str | TestStatus) -> TestStatus:
    ...
    Raises:
        ValueError: If the value is not a valid test status.
    """
