    ...
    *,
    ...
    if not tools_to_run:
        logger.console_output(
            text="All selected tools were filtered out by post-check configuration",
        )
        return 1
    ...
    for tool_enum in tools_to_run:
        try:
            ...
            # handles formatting.
            if "black" in post_tools_early and tool_name == ToolName.RUFF:
            ...
            elif result.output and not raw_output:
                # Use raw output only if raw_output flag is False
