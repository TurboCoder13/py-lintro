...
class PytestTool(BaseTool):
    ...
    def _process_test_results(
        ...
        Returns:
            tuple[dict, list]: Tuple of (summary_data, failed_issues).
        """
        # Process summary
        ...
        return (summary_data, failed_issues)
    ...
    def _build_result(
        ...
        Args:
            ...
            failed_issues: List of failed test issues.

        Returns:
            ToolResult: Final result object.
        """
        output_text = build_output_with_failures(summary_data, failed_issues)
    ...
    def _handle_timeout_error(
        ...
        error_msg = (
            ...
            "  - Some tests are hanging or blocked\n"
            "  - Need to increase timeout via --tool-options timeout=N\n\n"
            "Try:\n"
            "  - Run with fewer tests: lintro test tests/unit/\n"
            "  - Increase timeout: lintro test --tool-options timeout=600\n"
