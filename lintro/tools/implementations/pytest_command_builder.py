...
def add_output_options(cmd: list[str], options: dict) -> None:
    ...
    if junitxml_value:
        ...
        # Auto-enable junitxml in CI environments for better integration
        ...
        if not junitxml_explicit and auto_junitxml:
            ...
            logger.debug("Auto-enabled junitxml=report.xml in CI environment")
...
def build_check_command(
    ...
    # Add output options
    add_output_options(cmd, tool.options)
