...
class PytestConfiguration:
    ...
    _SPECIAL_MODE_MAPPING = [
        (PytestSpecialMode.LIST_PLUGINS, PytestSpecialMode.LIST_PLUGINS),
        (PytestSpecialMode.CHECK_PLUGINS, PytestSpecialMode.CHECK_PLUGINS),
        (PytestSpecialMode.COLLECT_ONLY, PytestSpecialMode.COLLECT_ONLY),
        (PytestSpecialMode.LIST_FIXTURES, PytestSpecialMode.LIST_FIXTURES),
        (PytestSpecialMode.LIST_MARKERS, PytestSpecialMode.LIST_MARKERS),
        (PytestSpecialMode.PARAMETRIZE_HELP, PytestSpecialMode.PARAMETRIZE_HELP),
    ]
    ...
    def get_special_mode(self) -> str | None:
        ...
        """
        for attr_name, mode_name in self._SPECIAL_MODE_MAPPING:
            if getattr(self, attr_name.value, False):
