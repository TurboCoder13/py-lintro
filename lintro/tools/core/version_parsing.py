...
# Import actual implementations from version_checking to override the dummy ones
from lintro.tools.core.version_checking import _get_install_hints, _get_minimum_versions
...
def _extract_version_from_output(output: str, tool_name: str | ToolName) -> str | None:
