...
3. The contribution was provided directly to me by some other person who certified (1),
   (2) or (3) and I have not modified it.
...
To sign off on your commits, use the `--signoff` or `-s` flag in `git commit` and ensure
your commit message contains a line like:
